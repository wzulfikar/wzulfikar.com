...
const bodySelectorSub=['h1[id]','h2[id]','h3[id]'].map(selector=>`${bodySelectorPrefix} ${selector}`).join(',')
document.querySelectorAll(bodySelectorSub).forEach(el=>{const id=el.id
